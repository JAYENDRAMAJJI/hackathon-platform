        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-base font-bold text-white flex items-center gap-2">
                <UserCheck className="w-4 h-4 text-purple-400" /> Assign Faculty Supervisors
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
                Select one or more faculty members to supervise this competition. Only assigned faculty can monitor this contest.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {availableFaculty.length === 0 ? (
              <p className="text-xs text-slate-400 col-span-2 py-4 text-center">No faculty members found in the directory.</p>
            ) : (
